...
public class BSTTest {
    ...
    public void testSize() {
        ...
        assertNull(sInstance.find("A"));

        sInstance.insert("A");
        assertEquals(sInstance.size(), 1);
        //BST.Node<String> result = sInstance.find("A");
    ...
    public void toStringTest() {
        ...
        for (Integer i : instance.inOrder()) {
    ...
    void findTest() {
        ...
        assertNotNull(instance.find(arr[0]));
        assertNotNull(instance.find(arr[arr.length - 2]));
        assertNotNull(instance.find(arr[arr.length - 3]));
    }
}
