...
public class GraphAlgorithmsTest {
    ...
    @Test
    void hashCodeTest() {
        Graph<String, String> copy = completeMap.clone();
        assertEquals(copy.hashCode(), completeMap.hashCode());

        copy = incompleteMap.clone();
        assertEquals(copy.hashCode(), incompleteMap.hashCode());
    }
}
