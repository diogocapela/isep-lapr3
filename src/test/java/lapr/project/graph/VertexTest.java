...
public class VertexTest {
    ...
    @Test
    void equalsTest() {
        Vertex<String, Integer> nova = new Vertex<>(instance);
        assertEquals(instance, nova);
        assertEquals(nova, instance);

        Edge<String, Integer> ed = new Edge<>();
        ed.setWeight(50.0);
        instance.addAdjVert("wololo", ed);

        Vertex<String, Integer> nova2 = new Vertex<>(instance);
        assertEquals(instance, nova2);
        assertEquals(nova2, instance);

        Vertex<String, String> v1 = new Vertex<>();
        v1.setElement("a");
    ...
    @Test
    void hashCodeTest() {
        instance.setElement("abc");
        Vertex<String, Integer> copy = instance.clone();
        assertEquals(copy.hashCode(), instance.hashCode());

        copy.setElement("asda");
