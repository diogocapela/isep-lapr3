...
public class GraphTest {
    ...
    private Graph<String, String> instance = new Graph<>(true);
    ...
    public void testToString() {
        assertEquals(20, instance.toString().length());

        instance.insertVertex("batatas");
        ...
        instance.insertVertex("batatass");
        s = instance.toString();
        assertTrue(s.length() > 20);
    ...
    @Test
    void hashCodeTest() {
        Graph<String, String> copy = instance.clone();
