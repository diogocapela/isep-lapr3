...
public class ScriptRunner {
    ...
    public ScriptRunner(Connection connection, boolean autoCommit,
        ...
        try (FileWriter fw = new FileWriter(logFile, logFile.exists())) {
            logWriter = new PrintWriter(fw);
        } catch (IOException e) {
            Logger.log("Unable to access or create the db_create log");
        } finally {
            if (logWriter != null) {
                logWriter.close();
            }
        ...
        try (FileWriter fw = new FileWriter(errorLogFile, errorLogFile.exists())) {
            errorLogWriter = new PrintWriter(fw);
        } catch (IOException e) {
            Logger.log("Unable to access or create the db_create error log");
        } finally {
        ...
        println(DASH_LINE + timeStamp + DASH_LINE);
        printlnError(DASH_LINE + timeStamp + DASH_LINE);
    }
