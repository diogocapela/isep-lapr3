...
public class Graph<V, E> implements GraphInterface<V, E> {
    ...
    public Iterable<Edge<V, E>> edges() {
        ...
        for (Vertex<V, E> tmpVertex : this.vertices.values()) {
            for (Edge<V, E> tmpEdge : tmpVertex.getAllOutEdges()) {
                result.add(tmpEdge);
            }
        }
    ...
    public String toString() {
        ...
        if (numVert == 0) {
            ...
            s.append("Graph: ").append(numVert).append(" vertices, ").
